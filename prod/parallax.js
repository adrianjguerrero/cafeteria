...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('scroll', function () {
    ...
    if (anchoVentana > 800) {
      ...
      var scroll = window.pageYOffset; //parallax hacia abajo para el cafe licidad
      // $('header .textos').css({
      ...
      */
      ...
      aboutArticle.style.transform = "translate(0px, -".concat(scroll / 5, "%)");
    }
  ...
  window.addEventListener('resize', function () {
    if (anchoVentana < 800) {
      ...
      /* without jquery */
      aboutArticle.style.transform = 'translate(0px,0px)'; //     //reiniciaremos sus valores, para asi no se vea feo al hacer resisa
    }
  });
});